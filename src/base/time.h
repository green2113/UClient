...
// Compatibility aliases for code still using legacy SEASON_* names.
inline constexpr ETimeSeason SEASON_SPRING = ETimeSeason::SPRING;
inline constexpr ETimeSeason SEASON_SUMMER = ETimeSeason::SUMMER;
inline constexpr ETimeSeason SEASON_AUTUMN = ETimeSeason::AUTUMN;
inline constexpr ETimeSeason SEASON_WINTER = ETimeSeason::WINTER;
inline constexpr ETimeSeason SEASON_EASTER = ETimeSeason::EASTER;
inline constexpr ETimeSeason SEASON_HALLOWEEN = ETimeSeason::HALLOWEEN;
inline constexpr ETimeSeason SEASON_XMAS = ETimeSeason::XMAS;
inline constexpr ETimeSeason SEASON_NEWYEAR = ETimeSeason::NEWYEAR;
inline constexpr int SEASON_COUNT = static_cast<int>(ETimeSeason::NEWYEAR) + 1;
inline constexpr ETimeSeason SEASON_VALENTINE = static_cast<ETimeSeason>(SEASON_COUNT);
