	...
	if(Event.m_Flags & IInput::FLAG_PRESS)
	{
		...
		if(Event.m_Key == KEY_MOUSE_1)
		{
			...
			if(m_OutIndex >= 0 && m_OutIndex < (int)vOuts.size())
			{
				...
				GameClient()->m_Camera.SetView(ivec2((int)(Out.x / 32.0f), (int)(Out.y / 32.0f)));
			}
			return true;
		}
	}
