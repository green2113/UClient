/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: c94a622dcfcf834e8166db7afefa7f94)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	CFG_BACKUPS: R2Bucket;
	DB: D1Database;
	uclient_rooms: D1Database;
	ASSETS: Fetcher;
	ENVIRONMENT: "development";
	RELAY_INVALIDATE_URL: "";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "RELAY_INVALIDATE_URL">> {}
}
