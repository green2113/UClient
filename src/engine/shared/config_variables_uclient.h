...
MACRO_CONFIG_INT(UcNotifyWhenBackMaxDistance, uc_back_notify_max_distance, 5, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Max race-progress gap (%) behind you for back freeze notify")
MACRO_CONFIG_INT(UcNotifyWhenBackIncludeSpec, uc_back_notify_include_spec, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Also show back notify when a teammate behind you /spec'd while on freeze")
