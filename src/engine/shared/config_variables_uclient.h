...
// AI assistant (settings / binds)
MACRO_CONFIG_INT(UcAiAssistant, uc_ai_assistant, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable UClient AI assistant overlay")
MACRO_CONFIG_STR(UcAiAssistantEndpoint, uc_ai_assistant_endpoint, 256, "https://ddnet.under1111.com/api/ai/assistant", CFGFLAG_CLIENT | CFGFLAG_SAVE, "HTTP endpoint for UClient AI assistant proxy")
MACRO_CONFIG_STR(UcAiAssistantHotkey, uc_ai_assistant_hotkey, 32, "f8", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hotkey name that toggles the AI assistant overlay")
MACRO_CONFIG_INT(UcAiAssistantOfflineFallback, uc_ai_assistant_offline_fallback, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Use local rule-based fallback when AI proxy is unavailable")
