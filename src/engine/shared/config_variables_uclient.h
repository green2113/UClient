...
MACRO_CONFIG_STR(UcUpdateLatestUrl, uc_update_latest_url, 256, "https://uclient.app/uclient/client/latest.json", CFGFLAG_CLIENT | CFGFLAG_SAVE, "HTTP endpoint used to fetch latest UClient client update metadata")
...
MACRO_CONFIG_INT(UcSpecTelePreview, uc_spec_tele_preview, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "In freeview, preview teleport destinations under the camera center")
