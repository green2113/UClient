...
MACRO_CONFIG_STR(UcApiBaseUrl, uc_api_base_url, 256, "https://uclient-rooms-server.kfyjbyrfb9.workers.dev", CFGFLAG_CLIENT | CFGFLAG_SAVE, "UClient account and chat room API base URL")
...
MACRO_CONFIG_INT(UcChatFriendsOnly, uc_chat_friends_only, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Only send UClient chat to friends and only show UClient chat from friends (overrides the same-server options)")
...
MACRO_CONFIG_INT(UcServerJoinShow, uc_server_join_show, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show UClient server join/leave announcements in chat")
MACRO_CONFIG_INT(UcServerJoinFriendsOnly, uc_server_join_friends_only, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Only announce join/leave to friends and only show join/leave messages from friends")
...
MACRO_CONFIG_INT(UcSwapHighlightSeconds, uc_swap_highlight_seconds, 60, 1, 3600, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Seconds to keep incoming swap requests highlighted in the scoreboard")
...
MACRO_CONFIG_STR(UcNotifyWhenBackText, uc_back_notify_text, 64, "Back", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Text for back freeze notify")
MACRO_CONFIG_COL(UcNotifyWhenBackColor, uc_back_notify_color, 256, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Color for back freeze notify")
MACRO_CONFIG_INT(UcNotifyWhenBackX, uc_back_notify_x, 20, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Horizontal position for back notify as percentage of screen width")
