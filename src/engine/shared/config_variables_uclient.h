...
MACRO_CONFIG_STR(UcPresenceUdpSharedToken, uc_presence_udp_shared_token, 256, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Shared token used to authenticate UClient presence UDP packets")
