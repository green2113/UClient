...
// Menu sound effects
MACRO_CONFIG_INT(BcMenuSfx, bc_menu_sfx, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable extra menu/UI sound effects (osu!-style hover/click/dialog sounds)")
MACRO_CONFIG_INT(BcMenuSfxVolume, bc_menu_sfx_volume, 100, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Volume of extra menu/UI sound effects, in percent")
...
MACRO_CONFIG_STR(BcChatMediaAllowedDomains, bc_chat_media_allowed_domains, 512, "tenor.com; imgur.com; giphy.com; media.uclient.app; gifs.teeworlds.xyz", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Semicolon-separated allowlist for chat media domains")
...
MACRO_CONFIG_INT(BcClientIndicatorSendInfo, bc_client_indicator_send_info, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Send usage info to BestClient indicator server (0=hidden, 1=broadcast). UClient presence is always broadcast.")
...
// Giphy GIF search popup position
MACRO_CONFIG_INT(BcGiphyPopupX, bc_giphy_popup_x, 50, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Giphy popup X position (percent)")
MACRO_CONFIG_INT(BcGiphyPopupY, bc_giphy_popup_y, 50, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Giphy popup Y position (percent)")
