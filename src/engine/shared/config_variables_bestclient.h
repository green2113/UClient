...
MACRO_CONFIG_STR(BcChatMediaAllowedDomains, bc_chat_media_allowed_domains, 512, "tenor.com; imgur.com; giphy.com; media.under1111.com", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Semicolon-separated allowlist for chat media domains")
...
MACRO_CONFIG_INT(BcChatAnimation, bc_chat_animation, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Toggle chat animation")
MACRO_CONFIG_INT(BcChatAnimationMs, bc_chat_animation_ms, 300, 1, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Chat animation time (in ms)")
MACRO_CONFIG_INT(BcChatOpenAnimation, bc_chat_open_animation, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Toggle chat open animation")
...
MACRO_CONFIG_INT(BcChatTypingAnimation, bc_chat_typing_animation, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Toggle chat typing animation")
...
MACRO_CONFIG_INT(BcClientIndicatorSendInfo, bc_client_indicator_send_info, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Send BestClient usage info to the client indicator servers")
...
MACRO_CONFIG_STR(BcLastSeenUpdateKey, bc_last_seen_update_key, 64, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Last seen BestClient update announcement key")
