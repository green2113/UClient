...
bool DecodeClipboardDib(const void *pData, size_t DataSize, IInput::SClipboardImage &Image)
{
	Image = {};
...
bool CInput::GetClipboardImage(SClipboardImage &Image)
{
	...
	const bool Success = pClipboardData != nullptr && ClipboardSize > 0 && DecodeClipboardDib(pClipboardData, (size_t)ClipboardSize, Image);
